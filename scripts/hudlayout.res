"Resource/HudLayout.res"
{
	...
	//--------------------------------------------------------------
	// Set visible/enabled to 1 to use. Change labelText to the corr-
	// esponding hitmarker in KnucklesCrosses.png. Change xpos/ypos
	// values if not perfectly centered.
	//--------------------------------------------------------------
	"HitmarkerName"
    {
		"controlName"		"CExLabel"
		"fieldName"			"HitmarkerName"
		...
		"labelText"			"g"				//Change text accordingly
		"textAlignment"		"center"
		"fgcolor"			"0 0 0 0"
    }
	//--------------------------------------------------------------
